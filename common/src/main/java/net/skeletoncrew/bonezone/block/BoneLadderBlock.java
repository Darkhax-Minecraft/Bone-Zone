...
public class BoneLadderBlock extends LadderBlock implements IBindRenderLayer {
    ...
    private static final BlockBehaviour.Properties PROPERTIES = BlockBehaviour.Properties.of().forceSolidOn().strength(0.4F).sound(SoundType.BONE_BLOCK).noOcclusion().pushReaction(PushReaction.DESTROY);
